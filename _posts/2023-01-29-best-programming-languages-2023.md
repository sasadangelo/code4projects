...
thumbnail: assets/img/top-programming-languages-2023.webp
...
This list was compiled using a mix of the [TIOBE inde](https://www.tiobe.com/tiobe-index/) and my experience in the industry. TIOBE is a measure of the popularity of programming languages. It is calculated based on the number of search engine results for queries of programming language tutorials, courses and examples. I've been working in the IT branch for over 24 years and I want to give my point of view on why these languages ​​can be worth studying.

## Python: The Swiss Army Knife of Programming Languages

![Python Language]({{ site.baseurl }}/assets/img/python-logo.webp){:width="300" height="329" .responsive_img}
...
I my daily job I used Python several time, [Patroni](https://github.com/zalando/patroni) is a Python cluster manager that I use to create high available PostgreSQL clusters for my company solutions. I use Python to monitor [my investments in ETFs](https://github.com/sasadangelo/finance), and several other projects.
...
Even if C has been around for several decades, it is a timeless language because it always manages to carve out a niche where performance is a must. The C language was my second programming language I learned in the last years of '80. I used it to creates games, small libraries, [small kernels](https://github.com/sasadangelo/gollumix), client applications, and so on. 
...
I started using this language as a hobby by creating [small compilers](https://github.com/sasadangelo/javacompiler). It was the first programming language I used when I started working in 1999. I remember that my first job was to develop an encryption library, then I developed other libraries in the configuration, networking, directory services areas.
...
![C# Language]({{ site.baseurl }}/assets/img/c-sharp-logo.png){:width="300" height="337" .responsive_img}
...
_Photo from [Wikipedia](https://en.wikipedia.org/wiki/PHP)_
...
I have been running Wordpress blog since 2006 and have written several [PHP code to customize my websites](https://github.com/sasadangelo/vantage-child). Unfortunately, today I have few opportunities to work on this language because I migrated my sites to Jeckyll.
...
Go, also known as Golang, is a programming language developed by Google in 2009. It is designed to be simple, efficient, and easy to learn. Go is particularly well-suited for building high-performance network services and distributed systems. It also has a built-in garbage collection, concurrency support, and strict typing. This makes it a great choice for building modern, scalable, and efficient applications.
...
One downside of Go is that it doesn't have a built-in support for generics, which is a feature that allows a function or a data type to work with multiple types of data. This can make some tasks more complex to implement, and it's something that developers have to take into account when choosing this language.
...
The Go language occupies a not too high position in the TIOBE index, however I wanted to add this language in this list because I notice that more and more it is used to write code for Cloud services and all the applications where performance is a MUST.
...
With my point of view from inside the IT world I also wanted to give a contribution on the languages ​​that I have noticed are most used in this industry.
