...
![Relational Database Service (RDS): What Is It and How Does It Work?](assets/img/Amazon-RDS.png){:width="393" height="200" }
...
![Amazon Relational Database Service](assets/img/Screenshot-2021-01-21-at-09.46.47.png)  
...
![Amazon Relational Database Service Instance](assets/img/Amazon-RDS-Instance.png)
...
![Amazon Relational Database Service in a VPC](assets/img/Amazon-RDS-VPC.png)
...
![Amazon RDS HA](assets/img/Amazon-RDS-HA.png)
...
![Amazon RDS Failover](assets/img/Amazon-RDS-Failover.png)
...
![Move RDS Cross AZ](assets/img/Move-RDS-Cross-AZ.png)
...
![Amazon RDS Read Replica](assets/img/Amazon-RDS-Read-Replica.png)
...
![RDS Encrypt Database](assets/img/RDS-Encrypt-Database.png)
...
![Amazon RDS in a VPC](assets/img/Amazon-RDS-VPC.png)
...
![RDS IAM Authentication](assets/img/RDS-IAM-Authentication.png)
...
![Amazon Aurora Architecture](assets/img/Amazon-Aurora-Architecture.png)
...
![Amazon Aurora DB Cluster](assets/img/Amazon-Aurora-DB-Cluster.png)
